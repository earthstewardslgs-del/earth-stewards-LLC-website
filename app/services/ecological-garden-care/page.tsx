...
export const metadata: Metadata = {
  ...
  description:
    'Learn what we mean by ecological landscaping—how we design landscapes that look intentional and become easier to manage over time in West Michigan conditions.',
  keywords:
    'ecological landscaping West Michigan, ecological landscaping Muskegon, low maintenance landscaping Muskegon MI, native landscaping Muskegon, climate adapted plants Michigan',
}
        ...
        <section className="py-24 bg-earth-50">
          <div className="max-w-5xl mx-auto px-6">
            ...
            <p className="text-xl text-earth-700 leading-relaxed mb-6">
              ...
              Plants outgrow their space, beds need constant resetting, and
              problem areas return every season.
            </p>

            <p className="text-lg text-earth-700 leading-relaxed">
              Ecological landscaping simply means designing a yard so it
              stabilizes instead of declining. Sometimes that includes native
              plants — but it also includes spacing, soil conditions, drainage
              patterns, and choosing plants suited to real conditions, not just
              appearance.
            </p>
          </div>
        </section>
        ...
        <section className="py-20 bg-earth-50">
          <div className="max-w-5xl mx-auto px-6">
            ...
            <p className="text-lg text-earth-700 mb-8">
              Ecological landscaping is often misunderstood. A stable landscape
              should still look intentional and cared for.
            </p>
        ...
        <section className="py-24 bg-moss-50">
          <div className="max-w-5xl mx-auto px-6">
            ...
            <p className="text-lg text-earth-700 leading-relaxed mb-8">
              Ecological landscaping isn’t a separate service — it’s how we
              approach all of them.
            </p>

            <div className="grid md:grid-cols-2 gap-6 text-lg text-moss-700 font-semibold">
              <a
                href="/services/native-landscaping-muskegon"
                className="hover:text-moss-800 transition-colors"
              >
        ...
        <section className="py-24 text-center bg-white">
          <div className="max-w-3xl mx-auto px-6">
            ...
            <p className="text-lg text-earth-700 leading-relaxed mb-10">
              If your yard keeps demanding more work every year, the design —
              not the effort — is usually the problem. Our goal is to help the
              space function so upkeep becomes simpler instead of constant.
            </p>
