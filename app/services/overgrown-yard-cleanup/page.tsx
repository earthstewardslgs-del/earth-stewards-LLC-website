        ...
        <section className="py-16 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
            <div className="prose prose-lg prose-earth max-w-none">
              ...
              <p>
                Sometimes a yard simply gets away from you — a few busy seasons, a move, or a neglected property — and it becomes hard to even know where to start.
              </p>
              <p>
                We reset the space with selective clearing and structure, creating a clean baseline so the property is manageable again and future improvements actually hold.
              </p>

              <h3>This is a good fit if:</h3>
              <ul className="list-disc pl-6 space-y-2">
                <li>You recently purchased a neglected property</li>
                <li>The yard feels overwhelming to tackle alone</li>
                <li>Paths, beds, or edges have disappeared into growth</li>
                <li>You want a clean starting point before planning next steps</li>
              </ul>
            </div>
