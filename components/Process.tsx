          ...
          {steps.map((step, index) => (
            ...
            >
              ...
              <div className="flex-1">
                <div className="bg-gradient-to-br from-moss-100 to-sage-100 rounded-2xl p-12 aspect-video flex items-center justify-center">
                  <div className="text-center text-moss-600">
