...
export default function Process() {
  const steps = [
    ...
    {
      number: '02',
      title: 'Clarify the Right Path',
      description:
        'From there, we determine the appropriate next step for your property.\n\nThat may include targeted improvements, a full ecological design plan, installation of defined projects, or ongoing maintenance and stewardship.\n\nNot every landscape needs a complete redesign. We scale the work to fit your goals, budget, and long-term vision.',
      icon: (
        <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      description:
        'If installation is part of the plan, we finalize scope, approve the proposal, and schedule the work. A deposit secures your installation date and plant material before we begin.\n\nIf maintenance is your priority, we establish a stewardship rhythm that supports ecological health over time — managing weeds, monitoring plant establishment, and adjusting as the landscape matures.',
      icon: (
        <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      description:
        'Landscapes evolve, and so do your goals.\n\nWe remain available for seasonal adjustments, phased expansions, ecological problem-solving, and long-term stewardship — ensuring your landscape continues to grow in both beauty and function.',
      icon: (
        <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
          ...
          {steps.map((step, index) => (
            ...
            >
              ...
              <div className="flex-1 space-y-4">
                ...
                <p className="text-lg text-earth-700 leading-relaxed whitespace-pre-line">
                  {step.description}
                </p>
              </div>
