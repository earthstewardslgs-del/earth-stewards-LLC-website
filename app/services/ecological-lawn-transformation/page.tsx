        ...
        <section className="py-16 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-earth-700 text-lg mb-6">
              Many lawn problems begin beneath the surface. When soil health declines, lawns become dependent on fertilizers, irrigation, and chemical treatments.
            </p>
            ...
            <p className="text-earth-700 text-lg italic">
              These issues are often symptoms of deeper soil and ecosystem imbalance.
            </p>
          </div>
        </section>
