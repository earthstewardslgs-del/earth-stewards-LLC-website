          ...
          <div>
            <div className="flex items-center space-x-3 mb-6">
              ...
              <div>
                ...
                <div className="text-xs text-moss-300">LLC</div>
              </div>
            </div>
            ...
            <div className="flex space-x-4">
              <a
                href="#"
                className="w-10 h-10 bg-earth-700 hover:bg-moss-600 rounded-full flex items-center justify-center transition-colors"
                aria-label="Facebook"
              >
                <svg
                  className="w-5 h-5"
          ...
          <div>
            ...
            <ul className="space-y-3 text-earth-300">
              <li className="flex items-start">
                <svg
                  className="w-5 h-5 text-moss-400 mr-2 flex-shrink-0 mt-0.5"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
              ...
              <li className="flex items-start">
                ...
                <span>Muskegon & Ottawa Counties, MI</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="pt-8 border-t border-earth-700">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-earth-400 text-sm">
              © {currentYear} Earth Stewards LLC. All rights reserved.
            </p>
            <div className="flex gap-6 text-sm">
              <a href="#" className="text-earth-400 hover:text-moss-400">
                Privacy Policy
              </a>
              <a href="#" className="text-earth-400 hover:text-moss-400">
                Terms of Service
