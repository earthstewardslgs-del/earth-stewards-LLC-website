...
export const metadata: Metadata = {
  title: 'Ecological Landscaping — How We Design Landscapes That Last',
  description: 'Most landscapes look good at installation but slowly become work. We design yards that stabilize instead of declining.',
  keywords: 'ecological landscaping, sustainable landscaping, low maintenance landscaping, landscape design Muskegon',
}
        ...
        <section className="py-24 bg-moss-50">
          <div className="max-w-5xl mx-auto px-6">
            ...
            <div className="grid md:grid-cols-2 gap-6 text-lg text-moss-700">
              <Link href="/services/native-landscaping-muskegon">Native Plant Landscapes →</Link>
              <Link href="/services/lawn-conversion-muskegon">Lawn Conversion →</Link>
              <Link href="/services/garden-restoration-muskegon">Garden Restoration →</Link>
              <Link href="/services/landscape-maintenance-muskegon">Long-Term Maintenance →</Link>
              <Link href="/services/soil-drainage-assessment">Soil & Drainage Assessment →</Link>
            </div>
          </div>
        </section>
